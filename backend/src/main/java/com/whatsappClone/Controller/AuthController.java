...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws UserException {
        ...
        if (isUser != null) {
            throw new UserException("Email is registered with another account");
        }
        ...
        return getAuthResponseResponseEntity(email, password);
    }
    ...
    private ResponseEntity<AuthResponse> getAuthResponseResponseEntity(String email, String password) {
